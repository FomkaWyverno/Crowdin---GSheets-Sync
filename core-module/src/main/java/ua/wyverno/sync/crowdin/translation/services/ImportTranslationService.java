...
public class ImportTranslationService extends BaseImportTranslationService {
     ...
     */
    @Override
    protected void processImport(List<SourceString> sourceStrings, Map<String, GSheetTranslateKey> mapGSheetKeysById, AtomicInteger counter, Set<Long> approveStringIds) {
